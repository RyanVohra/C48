...
function preload(){
  ...
  RB=loadImage("assets/reset button.png");
  GO=loadImage("assets/game_over.png");
  RE=loadImage("assets/restartImage.png");
...
if(gameState===PAUSE)
{
      ...
      if(lives===2){
        ...
        reset=createSprite(displayWidth/2,displayHeight/2+100);
        reset.addImage(RE);
...
function spawnZombies(){
  ...
  zombie.scale = 0.3
  zombie.velocityX=-(7+frameCount/320)
    zombie.debug=false;
